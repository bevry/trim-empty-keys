...
``` typescript
import pkg from 'https://unpkg.com/trim-empty-keys@^1.1.0/edition-deno/index.ts'
```
### [Skypack](https://www.skypack.dev "Skypack is a JavaScript Delivery Network for modern web apps")

``` html
<script type="module">
    import pkg from '//cdn.skypack.dev/trim-empty-keys@^1.1.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/trim-empty-keys@^1.1.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/trim-empty-keys@1.1.0'
</script>
```
